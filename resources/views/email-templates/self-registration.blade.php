...
?>
  ...
  <div style="width:595px;margin:auto; background-color:white;
      ...
      <span style="font-weight: 400;font-size: 14px;line-height: 135.5%;color: #182E4B;display:block; margin-bottom:34px;">{{__($status=='approved'?'messages.Thank_you_for_joinning_with':'messages.Thank_you_for_the_joinning_request_on')}} <span style="color: #d62828;">{{$company_name}}!</span></span>
