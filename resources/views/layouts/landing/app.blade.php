...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('storage/business/'. $icon ?? '') }}">
    ...
    @php($toggle_dm_registration = \App\Models\BusinessSetting::where(['key' => 'toggle_dm_registration', 'value' => 1] )->first())
    @php($toggle_restaurant_registration = \App\Models\BusinessSetting::where(['key' => 'toggle_restaurant_registration', 'value' => 1])->first())
