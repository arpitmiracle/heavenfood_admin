...
@section('content')
    ...
    <section class="banner-section"
        style="background: url('{{asset('storage/header_image')}}/{{$landing_data['header_bg_image']}}') no-repeat center center / cover">
        ...
        <div class="container">
            <div class="banner-wrapper">
                <div class="banner-thumb wow fadeInUp">
                    <img class="main-img"
                    src="{{asset('storage/header_image')}}/{{ $landing_data['header_content_image']   }}"
        ...
        <div class="container">
            <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-5 text-lg-end text-center wow fadeInLeft">
                    <img
                    src="{{asset('storage/about_us_image')}}/{{ $landing_data['about_us_image_content']  }}"
            ...
            <div class="feature-slider owl-theme owl-carousel">
                ...
                <div class="feature-item wow fadeInUp">
                    <div class="feature-item-icon">
                        <img
                        src="{{ asset('storage/feature_image') }}/{{ $feature_data['image'] }}" alt="">
                    </div>
        ...
        <div class="container">
            ...
            @if (isset($landing_data['why_choose_us_image_1']))
                ...
                <div class="choose-item wow animate__dropIn">
                                <img
                    src="{{asset('storage/why_choose_us_image')}}/{{ $landing_data['why_choose_us_image_1'] }}"
                    alt="Image">
            ...
            @if (isset($landing_data['why_choose_us_image_2']))
                ...
                <div class="choose-item wow animate__dropIn">
                                <img
                    src="{{asset('storage/why_choose_us_image')}}/{{ $landing_data['why_choose_us_image_2'] }}"
                    alt="Image">
                    <div class="choose-item-content">
                        <div class="cont">
                            <h4 class="title">
            ...
            @if (isset($landing_data['why_choose_us_image_3']))
                ...
                <div class="choose-item wow animate__dropIn">
                                <img
                    src="{{asset('storage/why_choose_us_image')}}/{{ $landing_data['why_choose_us_image_3'] }}"
                    alt="Image">
                    <div class="choose-item-content">
                        <div class="cont">
                            <h4 class="title">
            ...
            @if (isset($landing_data['why_choose_us_image_4']))
                <div class="choose-item wow animate__dropIn">
                                <img
                    src="{{asset('storage/why_choose_us_image')}}/{{ $landing_data['why_choose_us_image_4'] }}"
                    alt="Image">
                    <div class="choose-item-content">
                        <div class="cont">
                            <h4 class="title">
        ...
        <div class="container">
            <div class="row align-items-end justify-content-end">
                ...
                <div class="col-md-5 text-center">
                    ...
                    src="{{ asset('storage/earn_money') }}/{{  $landing_data['earn_money_reg_image']  }}"
                    alt="">
                </div>
            </div>
        </div>
                ...
                <div class="testimonial-item" dir="ltr">
                    <div class="position-relative">
                        ...
                        <div id="sync2" class="owl-theme owl-carousel mb-4 mb-md-5">
                            ...
                            <div class="img">
                                <img src="{{asset('storage/reviewer_image')}}/{{ $data['reviewer_image'] }}" alt="">
                            </div>
                            @endforeach
                        </div>
                    </div>
