...
<html dir="{{ $site_direction }}" lang="{{ $locale }}" class="{{ $site_direction === 'rtl'?'active':'' }}">
    ...
    @endphp
    <!-- Title -->
    <title>{{ translate('messages.Verify_otp') }} | {{$app_name??translate('Heavenfood')}}</title>
...
<main id="content" role="main" class="main auth-bg">
    <div class="d-flex flex-wrap align-items-center justify-content-between">
        <div class="auth-content">
            <div class="content">
                <h2 class="title text-uppercase">{{translate('messages.welcome_to_app')}} {{ $app_name??'Heavenfood' }}</h2>
                    <p>
