...
<head>
    ...
    <!-- Title -->
    <title>{{translate('messages.error')}} 500 | {{\App\Models\BusinessSetting::where(['key'=>'business_name'])->first()->value??'heaven Food'}}</title>
...
<div class="footer text-center">
    <ul class="list-inline list-separator">
        <li class="list-inline-item">
            <a class="list-separator-link" target="_blank" href="https://6amtech.com/">{{\App\Models\BusinessSetting::where(['key'=>'business_name'])->first()->value??'heaven Food'}} {{translate('messages.support')}}</a>
        </li>
    </ul>
</div>
<!-- End Footer -->
