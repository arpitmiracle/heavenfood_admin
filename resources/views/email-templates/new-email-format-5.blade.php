    ...
    <table dir="{{ $site_direction }}" style="width:100%;max-width:500px;margin:0 auto;text-align:center;background:#fff">
        ...
        <tr>
            <td style="padding:0 30px 30px; text-align:left">
                ...
                @if ($logo)
                <img style="width:120px;display:block;margin:10px auto" src="{{ asset('storage/business/' . $logo) }}" alt="public/img">
                @else
                ...
                <span class="copyright" id="mail-copyright">
                    {{ $copyright_text?? translate('Copyright_2023_Heavenfood._All_right_reserved') }}
                </span>
            </td>
        </tr>
    </table>
