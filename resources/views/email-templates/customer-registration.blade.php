...
?>
  ...
  <div style="width:595px;margin:auto; background-color:white;
      ...
      <span style="font-weight: 400;font-size: 14px;line-height: 135.5%;color: #182E4B;display:block; margin-bottom:34px;">{{translate('messages.Thank_you_for_joinning_with')}} <span style="color: #d62828;">{{$company_name}}!</span></span>
      ...
      @if ($type)
      <span style="font-weight: 400;font-size: 14px;line-height: 135.5%;color: #182E4B;display:block; margin-bottom:34px;">{{translate('Default_login_password: ')}} <span style="color: #d62828;">password</span></span>
      @endif
      @if ($company_links['web_app_url_status'])
          <a href="{{$company_links['web_app_url']}}" target="_blank" style="width: 100px;height: 40px;left: 247px;top: 321px;background: #d62828;border-radius: 5px; padding: 10px;text-decoration: none;color: white;">{{translate('messages.Buy_Now')}}</a>
      @endif
